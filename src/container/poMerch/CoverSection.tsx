  ...
  return (
    <div className='bg-cgray overflow-hidden relative z-40 md:min-h-main'>
      ...
      <NextImage
        ...
        priority={true}
        quality={100}
        className='-translate-x-[2rem] -translate-y-[6.5rem] bottom-[50%] left-[50%] scale-[.3] absolute z-50 sm:-translate-y-[10rem] md:-translate-x-[.5rem] md:-translate-y-[11.5rem] lg:-translate-y-[12.5rem]'
      />
      <NextImage
        ...
        alt='bg'
        priority={true}
        className='-translate-x-[10rem] bottom-[50%] left-[50%] translate-y-[9rem] absolute sm:translate-y-[10.5rem] md:-translate-x-[12.5rem] md:translate-y-[9.5rem] lg:translate-y-[8.5rem]'
      />
      <div className='grid-cols layout min-h-[calc(100vh-64px-32px)] text-cdark grid relative z-10 lg:min-h-[calc(100vh-64px-64px)]'>
        ...
        <div className='flex flex-col gap-4 justify-center items-center text-center lg:mt-0'>
          ...
          <div className='my-2 sm:my-4'>
            <MerchPageCarousel className='w-[14rem] sm:w-[18rem]' />
          </div>
          <h1 className='text-cdark'>
            R<span className='font-pilow font-normal'>E</span>D BUNDLE
          </h1>
          <h4 className='mt-[-1rem] text-cdark max-w-lg sm:mt-2'>
