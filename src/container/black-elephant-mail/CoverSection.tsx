...
export default function CoverSection({
  ...
  return (
    <div style={{ perspective: '1800px' }} className='layout z-10'>
      ...
      >
        <div
          className={clsxm('block relative', {
            'hidden pointer-events-none': state === 'FILL',
          })}
        ...
        <div
          className={clsxm('block relative', {
            'hidden pointer-events-none ': state === 'BEFORE',
          })}
          style={{
