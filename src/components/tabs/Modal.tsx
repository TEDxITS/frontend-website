    ...
    <>
      <div className='flex fixed inset-0 justify-center items-center'>
        <button
          type='button'
          onClick={openModal}
          className='px-4 py-2 text-sm font-medium text-white bg-black bg-opacity-20 rounded-md hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'
        >
          Open dialog
        </button>
      </div>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog
          as='div'
          className='bg-cdark/75 overflow-y-auto fixed inset-0 z-10'
          onClose={closeModal}
        >
