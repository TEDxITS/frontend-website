...
export default function GrandThemePage() {
  return (
    <Layout>
      ...
      <main className='bg-newspaper flex overflow-hidden flex-col pt-8 bg-center bg-cover md:pt-16'>
        <Header isDark={true} />
        ...
        <section className='bg-newspaper min-h-main py-16 bg-top bg-no-repeat bg-cover'>
          <LogoSection />
        </section>
      </main>
    </Layout>
