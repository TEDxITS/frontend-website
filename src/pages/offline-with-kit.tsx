...
import OfflineKitCheckout from '@/container/ticketing/OfflineKitCheckout';
import TicketingCard from '@/container/ticketing/TicketingCard';

export default function offlineWithKit() {
  return (
    <Layout withDashboard={true} className='bg-cgray' isDark={true}>
      <Seo templateTitle='Checkout' />
      <main className='flex overflow-hidden flex-col gap-8 pt-8 md:pt-16'>
        <div className='flex gap-16 justify-center'>
          <TicketingCard type='offline-with-kit'>
